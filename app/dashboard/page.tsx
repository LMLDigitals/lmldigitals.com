    ...
    <div id="webcrumbs">
      <main className="p-6 flex flex-col gap-8 w-full">
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-neutral-100 dark:bg-neutral-800 rounded-md p-4 flex flex-col items-center border border-neutral-300 dark:border-neutral-700 shadow-md">
        ...
        <section className="relative">
          <details className="relative z-10">
            ...
            <div className="absolute bg-neutral-50 dark:bg-neutral-900 shadow-md p-4 mt-2 rounded-md border border-neutral-300 dark:border-neutral-700">
        ...
        <section className="flex flex-col lg:flex-row gap-6">
          <div className="bg-neutral-100 dark:bg-neutral-800 rounded-md p-4 w-full lg:w-1/2 border border-neutral-300 dark:border-neutral-700 shadow-md">
